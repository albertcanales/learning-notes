...
- **enable / disable**: Afecten _només_ al boot, no fa start i stop

## Targets

- **Wants / Wanted By**: _MAY_ iniciar al mateix temps
- **Requires / Required By**: _MUST_ iniciar al mateix temps
