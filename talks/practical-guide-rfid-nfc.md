<!-- FRONT
title = "Practical Guide to Hacking RFID/NFC"
description = "Sławomir Jasek"
-->
...
Sovint per la connexió _Lector -> Control_ s'envia la lectura desencriptada de la targeta. Si el lector és fàcilment desmuntable, es podria fer un MITM.
...
- S'utilitzen keys per defecte o estan leakejades?
  - _SI_. Fet!
  - _NO_. Es té almenys una clau?
    - _SI_. **Nested Attack**: Amb un _PN532_, pot tardar uns minuts
    - _NO_. **Darkside Attack**: Amb un _PN532_, pot tardar una hora

Les versions més actuals de MIFare ja han parchejat errors com els utilitzats en la Classic. L'atac al model més modern a data de la conferència és diu _MyLazyCracker_.
